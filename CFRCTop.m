function CFRCTop(nelx,nely,he,thickness,volfrac,rmin,rmin_p)
%% Material properties
...
while (change>0.01 && iter<maxiter)
    ...
    dfdp = [Hp*(dcdpxTiles./Hps);Hp*(dcdpyTiles./Hps)];
